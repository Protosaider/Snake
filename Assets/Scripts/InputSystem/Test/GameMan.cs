...
public class GameMan : MonoBehaviour {
	...
	void Awake()
	{
        ...
        //Debug.Log(PlayerPrefs.HasKey("Jump"));
        //Debug.Log(PlayerPrefs.GetString("jumpKey", "Space"));
        //Debug.Log(System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString("jumpKey", "Space")));
        //Debug.Log(jump);

        Debug.Log(System.Enum.Parse(typeof(KeyCode), "Tab"));
        Debug.Log((KeyCode)System.Enum.Parse(typeof(KeyCode), "Tab"));

    }

    private void Update()
    {
        Debug.Log(Input.GetKey("TAB"));
    }
}
